...
"""
Test script for IndexBuilder module
...
def test_index_builder():
    ...
    print("\n🔧 Initializing IndexBuilder...")
    index_builder = IndexBuilder(model_manager, collection_name="test_documents")
    
    # Test building index from folder
    print(f"\n📚 Building index from folder: {data_folder}")
    try:
    ...
    for query in test_queries:
        print(f"\n🔎 Query: '{query}'")
        try:
            results = index_builder.search(query, n_results=3)
